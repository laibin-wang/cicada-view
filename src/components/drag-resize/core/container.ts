...
import { PositionStore, UpdatePosition, Position, GetPositionStore, MatchedLine, SetMatchedLine } from '../type'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const state = reactive<{ matchedLine: MatchedLine | null }>({ matchedLine: null })
    ...
    return { matchedRows, matchedCols }
  },
  methods: {
    renderReferenceLine() {
